...
var ViewDesc = class {
  ...
  setSelection(anchor, head, root, force = false) {
    ...
    for (let i = 0, offset3 = 0; i < this.children.length; i++) {
      let child = this.children[i], end = offset3 + child.size;
      if (from2 > offset3 && to < end) return child.setSelection(anchor - offset3 - child.border, head - offset3 - child.border, root, force);
      offset3 = end;
    }
...
_ImageViewComponent.ɵfac = function ImageViewComponent_Factory(__ngFactoryType__) {
...
_NgxEditorComponent.ɵfac = function NgxEditorComponent_Factory(__ngFactoryType__) {
...
_NgxEditorServiceConfig.ɵfac = function NgxEditorServiceConfig_Factory(__ngFactoryType__) {
...
_NgxEditorService.ɵfac = function NgxEditorService_Factory(__ngFactoryType__) {
...
_SanitizeHtmlPipe.ɵfac = function SanitizeHtmlPipe_Factory(__ngFactoryType__) {
...
_ToggleCommandComponent.ɵfac = function ToggleCommandComponent_Factory(__ngFactoryType__) {
...
_InsertCommandComponent.ɵfac = function InsertCommandComponent_Factory(__ngFactoryType__) {
...
_ImageComponent.ɵfac = function ImageComponent_Factory(__ngFactoryType__) {
...
_ColorPickerComponent.ɵfac = function ColorPickerComponent_Factory(__ngFactoryType__) {
...
_BubbleComponent.ɵfac = function BubbleComponent_Factory(__ngFactoryType__) {
...
_FloatingMenuComponent.ɵfac = function FloatingMenuComponent_Factory(__ngFactoryType__) {
...
_NgxEditorModule.ɵfac = function NgxEditorModule_Factory(__ngFactoryType__) {
